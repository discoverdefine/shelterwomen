...
function populateTourRoomsHtml(tx, results) {
    ...
    db.transaction(
        function(transaction) {
            ...
            transaction.executeSql("SELECT * FROM da_shelter_images WHERE image_path = 'c1.jpg' OR image_path = 'c2.jpg' OR image_path = 'c3.jpg' OR image_path = 'c4.jpg'", [], function(tx, results) {
